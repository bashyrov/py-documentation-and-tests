...
class CinemaHallViewSet(
    ...
    def retrieve(self, request, *args, **kwargs):
        """Get specific cinema hall by ID"""
        return super().retrieve(request, *args, **kwargs)
    ...
    @extend_schema(
        ...
        parameters=[
            ...
            OpenApiParameter(
                "title",
                type=str,
                description="Filter movies by title containing this string",
            ),
        ],
    )
    def list(self, request, *args, **kwargs):
        """Get list of movies, optionally filtered by genres"""
        return super().list(request, *args, **kwargs)
...
class MovieSessionViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        """Get specific movie session by ID"""
        return super().retrieve(request, *args, **kwargs)
